...
const translations = {
    fa: {
        ...
        'experience.network.title': ' شبیه‌سازی شبکه‌های کامپیوتری',
    ...
    en: {
        ...
        'experience.network.title': 'Computer Network Simulation',
        ...
        'social.lead': 'For collaboration or a quick chat, use the links below:',
        'social.email': 'Email',
